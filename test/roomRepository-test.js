...
describe('RoomRepository', function() {
  beforeEach(function() {
    ...
    bookingsData = JSON.parse('{"bookings":[{"id":"5fwrgu4i7k55hl6sz","userID":9,"date":"2022/04/22","roomNumber":1},{"id":"5fwrgu4i7k55hl6t5","userID":43,"date":"2022/01/24","roomNumber":2},{"id":"5fwrgu4i7k55hl6t6","userID":13,"date":"2022/01/10","roomNumber":3},{"id":"5fwrgu4i7k55hl6t7","userID":20,"date":"2022/02/16","roomNumber":4},{"id":"5fwrgu4i7k55hl6t8","userID":1,"date":"2022/02/05","roomNumber":5}]}' )
  ...
  it.skip('should return unbooked rooms that match both the date and the roomType chosen', function() {
    // happy path
  ...
  it.skip('should return an empty array if no rooms match', function() {
    // sad path
